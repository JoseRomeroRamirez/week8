...
public class PrintViewProfileText extends BasePageObject {
    public PrintViewProfileText(WebDriver driver, Logger log) {
        super(driver, log);
    }
    public void execute(){
        herokuappHoverPage herokuappHoverPage = new herokuappHoverPage(driver, log);
        herokuappHoverPage.printViewProfileTextUserTwo();
    }
}